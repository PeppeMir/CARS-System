 ...
 *  \param msg  struttura che conterra' il messaggio letto 
...
/** crea una connessione al socket del server. In caso di errore funzione tenta NTRIALCONN volte la connessione (a distanza di 1 secondo l'una dall'altra) prima di ritornare errore.
